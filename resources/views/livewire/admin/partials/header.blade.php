                                            ...
                                            <div class="media align-items-center mb-4">
                                                ...
                                                <div class="media-body profile-detail ml-3 rtl-mr-3 rtl-ml-0">
                                                    ...
                                                    <div class="d-flex flex-wrap">
                                                        <p class="mb-1">Web designer</p><button wire:click="logout" class="btn btn-sm ml-3 rtl-mr-3 rtl-ml-0">
                                                            <x-slot name="content">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6  col-6 pr-0">
                                                <div class="profile-details text-center">
                                                    <a href="https://templates.iqonic.design/instadash/html/app/user-profile.html" class="iq-sub-card bg-primary-light rounded-small p-2"> 
                                            ...
                                            <div class="col-lg-6  col-md-6 col-6">
                                                <div class="profile-details text-center">
                                                    <a href="https://templates.iqonic.design/instadash/html/app/user-profile-edit.html" class="iq-sub-card bg-danger-light rounded-small p-2">
                                                        <div class="rounded iq-card-icon-small">
                                            ...
                                            <div class="col-lg-6 col-md-6  col-6 pr-0">
                                                <div class="profile-details text-center">
                                                <a href="https://templates.iqonic.design/instadash/html/app/user-account-setting.html" class="iq-sub-card bg-success-light rounded-small p-2">
                                                        <div class="rounded iq-card-icon-small">
                                            ...
                                            <div class="col-lg-6 col-md-6  col-6">
                                                <div class="profile-details text-center">
                                                    <a href="https://templates.iqonic.design/instadash/html/app/user-privacy-setting.html" class="iq-sub-card bg-info-light rounded-small p-2">
                                                        <div class="rounded iq-card-icon-small">
